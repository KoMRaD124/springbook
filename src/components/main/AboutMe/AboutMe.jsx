...
import { photo,photoMob } from "../../../assets/main";
export const AboutMe = () => {
  return (
    <div id="aboutMe" className={styles.wrapper}>
      <div className={styles.body}>
        <div className={styles.imgBlock}>
          <img  className={styles.imgBlockPhoto} src={photo} alt="" />
          <img  className={styles.imgBlockMob} src={photoMob} alt="" />
        </div>
        <div className={styles.aboutMeBlock}>
          <div className={styles.aboutMeBlockTitle}>ОБО МНЕ</div>
          <div className={styles.aboutMeBlockHead}>
            Училась в Нетологии
            <br /> Сейчас сотрудничаю с&nbsp;<a className={styles.link} target="_blank" rel="noreferrer" href="https://кодим.рф">
              веб-студией
            </a>
          </div>
